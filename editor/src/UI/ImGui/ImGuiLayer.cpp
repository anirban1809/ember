...
void ImGuiLayer::Init(void* windowHandle) {
    ...
    //     ImVec4(0.92f, 0.93f, 0.94f, 1.00f);  // Light grey text for
    //     readability
    ...
    //     ImVec4(0.24f, 0.26f, 0.28f, 1.00f);  // Dark accent for scrollbar
    //     grab
    ...
    //     ImVec4(0.24f, 0.34f, 0.44f, 1.00f);  // Header color similar to
    //     button
    ...
    // colors[ImGuiCol_Tab] = ImVec4(0.20f, 0.22f, 0.24f, 1.00f);  // Inactive
    // tab colors[ImGuiCol_TabHovered] =
    ...
    //     ImVec4(0.80f, 0.80f, 0.80f, 0.35f);  // Dim background for modal
    //     windows
